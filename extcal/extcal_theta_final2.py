...
def maincode():
    ...
    fsuff='_theta_final2_newBprofBS_Br%d_Ind%.2f_%s'%(int(brad),ind,nepmod)
    if bzlim != None:
    ...
    for b in band:
        ...
        for a in arange(nalph):
            ...
            for t in arange(nth):
                ...
                Kc3[a,t,b]=K6[a,t,b]/(KpipE[b])#/arcsec2sr(areas[b]))
...
#    fsumm.write(lsum)
    ...
    for b in band:
        ...
        for t in arange(nth):
            ...
            fKmonEat.write('%.3f'%thetarr[t]) #row headings
            fKcolEat.write('%.3f'%thetarr[t]) #row headings
            fKcolEtat.write('%.3f'%thetarr[t]) #row headings
            for a in arange(nalph):
