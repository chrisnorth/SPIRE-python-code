...
####        plot3(px3,fw3)
    ...
    if pcorr:
        ...
        plotK5(alpharr,K5,fsuff,figK5,labK5)
        ##################################################
...
###        plotKcr(radlist,alphaplot,Kc2radrel,bsw,fsuff,figKcr)
    ...
    if pbmap:
        ...
        fitsInPsw='../Bernhard/0x5000241aL_PSW_pmcorr_1arcsec_cln_bgsub-cutTrim.fits'
        plotprettybeam(figbmappsw,labbmappsw,fitsIn=fitsInPsw,band='psw')

        print 'Plotting PMW beam map'
        fitsInPmw='../Bernhard/0x5000241aL_PMW_pmcorr_1arcsec_cln_bgsub-cutTrim.fits'
        plotprettybeam(figbmappmw,labbmappmw,fitsIn=fitsInPmw,band='pmw')
        
        print 'Plotting PLW beam map'
        fitsInPlw='../Bernhard/0x5000241aL_PLW_pmcorr_1arcsec_cln_bgsub-cutTrim.fits'
    ...
    if pblim:
        ...
        #print radarr
        #print beam_cmb_lim[:,0,0]
        #print beam_cmb_lim[:,2,0]
    ...
    if parear or pbcomp:
        ...
        for b in band:
            for r in arange(nrad_a):
                ...
                areas_r[r,b]=areas_r[r,b]*prof2map[b]
...
def plotrsrf(nuarr,rsrfarr,rsrfearr,apfarr,fsuff,figRSRF,figlab):
    ...
    plot.clf()
    #plot rsrf
    plot.plot(nuplt,rsrfarr[:,0],'b-',label=r'Spectral Response')
    plot.plot(nuplt,rsrfarr[:,1],'g-',label=r'_nolegend_')
    plot.plot(nuplt,rsrfarr[:,2],'r-',label=r'_nolegend_')
    ...
    plot.plot(nuplt,apfarr[:,0],'b--',label=r'Aperture Efficiency')
    plot.plot(nuplt,apfarr[:,1],'g--',label=r'_nolegend_')
    plot.plot(nuplt,apfarr[:,2],'r--',label=r'_nolegend_')
    
    plot.ylim(0.,1.)
    plot.xlim(0.3,1.7)
    plot.xlabel(r'Frequency [THz]')
    plot.ylabel(r'RSRF, ApEff')
    #plot.title('RSRF and Aperture Efficiency')
    plot.legend(frameon=False)
    plot.xticks(plot.xlim())
    plot.yticks(plot.ylim())

    plot.box=False
    plot.annotate(r'PSW',(1.250,0.05),ha='center',color='b',weight='bold',size='medium',family='sans-serif',va='center')
    plot.annotate(r'PMW',(0.900,0.05),ha='center',color='g',weight='bold',size='medium',family='sans-serif',va='center')
    plot.annotate(r'PLW',(0.600,0.05),ha='center',color='r',weight='bold',size='medium',family='sans-serif',va='center')
    #plot.annotate(r'PSW',(1.250,0.78),ha='center',color='k',weight='bold',size='x-large',family='sans-serif',va='center')
    #plot.annotate(r'PMW',(0.900,0.78),ha='center',color='k',weight='bold',size='x-large',family='sans-serif',va='center')
    #plot.annotate(r'PLW',(0.600,0.78),ha='center',color='k',weight='bold',size='x-large',family='sans-serif',va='center')
    ...
    if figRSRF =='-':
        figname='../Docs/Presentation/Figs/rsrf'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+figRSRF+'_rsrf'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
...
#    plot.ylabel('y ["]')
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/beams'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beams'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    ##plot.savefig(figname+'.eps',transparent=False)
...
def plotKc(alpharr,Kc,Kce,fsuff,figKc,figlab):
    ...
    plot.figure(3)
    plot.clf()
    plot.plot(alpharr,Kc[:,0],'b-',label=r'PSW')
    plot.plot(alpharr,Kc[:,1],'g-',label=r'PMW')
    plot.plot(alpharr,Kc[:,2],'r-',label=r'PLW')
    ...
    plot.ylabel(r'$K_\mathrm{ColP}(\alpha)$')
    plot.xticks([-4,-1,2,5])
    plot.yticks(plot.ylim())
    ...
    if figKc =='-':
        figname='../Docs/Presentation/Figs/colcorr'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+figKc+'_colcorr'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotbeam_cut(cutx,cuty,beam_cutx,beam_cuty,brad,fsuff,fignum,figlab):
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/beamcuts'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beamcuts'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotareaf(nuarr,area_bm,ilim,avgnu,avgarea,ith,fsuff,fignum,figlab,unit='sr'):
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/beamarea_nu'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beamarea_nu'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotarear(radarr,areas,fsuff,fignum,figlab,unit='sr'):
    ...
    na=areas[:,0].size
    #plot.subplot(2,1,2)
    plot.plot(radarr,areas[:,0]/areas[na-1,0],'b-',label=r'PSW')
    plot.plot(radarr,areas[:,1]/areas[na-1,1],'g-',label=r'PMW')
    plot.plot(radarr,areas[:,2]/areas[na-1,2],'r-',label=r'PLW')
    
    #plot.axhline(1.,color='k',linestyle='-')
    plot.xlabel(r'Radius ["]')
    plot.ylabel(r'Relative Beam area')
    plot.legend(loc='lower right',ncol=2)
    plot.ylim(0.98,1.005)
    plot.xlim(radarr[na-1]/2.,radarr[na-1])
    plot.xticks(plot.xlim())
    plot.yticks(plot.ylim())

    #plot.yticks([plot.ylim()[0],1.,plot.ylim()[1]])
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/beamarea_rad'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beamarea_rad'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False) 
...
def plotbeam_sm(radarr,beam_sm,beam_min,beam_max,beam_sd,brad,fsuff,fignum,fignum_all,figlab,figlab_all):
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/azbeam_range'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_azbeam_range'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False) 
    ...
    if fignum_all =='-':
        figname='../Docs/Presentation/Figs/azbeam_all'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum_all+'_azbeam_all'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False) 
...
def plotK4(alpharr,K4,K4e,fsuff,figK4,figlab):
    ...
    plot.figure(9)
    plot.clf()
    plot.plot(alpharr,K4[:,0],'b-',label=r'PSW')
    plot.plot(alpharr,K4[:,1],'g-',label=r'PMW')
    plot.plot(alpharr,K4[:,2],'r-',label=r'PLW')

    
    plot.xlabel(r'Spectral index ($\alpha$)')
    plot.xticks([-4,-1,2,5])
    plot.yticks(plot.ylim())
    plot.ylabel(r'K$_\mathrm{MonP}$')
    ...
    if figK4 =='-':
        figname='../Docs/Presentation/Figs/KmonP'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+figK4+'_KmonP'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotK5(alpharr,K5,fsuff,figK5,figlab):
    ##############################################################
    ##plot colour correction factors
    plot.figure(59)
    plot.clf()
    plot.plot(alpharr,K5[:,0]/1.e6,'b-',label=r'PSW')
    plot.plot(alpharr,K5[:,1]/1.e6,'g-',label=r'PMW')
    plot.plot(alpharr,K5[:,2]/1.e6,'r-',label=r'PLW')
    
    plot.xlabel(r'Spectral index ($\alpha$)')
    plot.ylabel(r'K$_\mathrm{MonE}$ Correction factor [MJy/sr per Jy/beam]')
    plot.ylim([0,100])
    ...
    if figK5 =='-':
        figname='../Docs/Presentation/Figs/KmonE'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+figK5+'_KmonE'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotK6(arr_a,arr_t,K6,fsuff,fignum,figlab):
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/K6corr'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_K6corr'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKc3(arr_a,arr_t,Kc3,fsuff,fignum,figlab):
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/Kc3corr'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_Kc3corr'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKc3t(arr_a,arr_t,Kc3t,fsuff,fignum,figlab):
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/Kc3tcorr'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_Kc3tcorr'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    ###plot.savefig(figname+'.eps',transparent=False)    
...
def plotareaa(alpharr,areaeff,areapip,areaa_fit,fitpar,fsuff,fignum,figlab):
    ...
    plot.clf()
    for b in range(3):
        plot.plot(alpharr,areaeff[:,b]/areapip[b],c=cols[b],ls=styles[b],label=bandStr[b])
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/beamarea_alpha'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beamarea_alpha'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/beamarea_alpha_withfitdeg'+str(afita-1)+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beamarea_alpha_withfitdeg'+str(afita-1)+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotareat(temparr,beta1,beta2,area_efft1,area_efft2,areapip,areat1_fit,areat2_fit,fitpart1,fitpart2,fsuff,fignum,figlab):
    ...
    bandStr=[r'PSW',r'PMW',r'PLW']
    #cols=['b','g','r']
    plot.figure(54)
    plot.clf()
    
    plot.plot(temparr,area_efft1[:,0]/areapip[0],'b-',label=r'%s ($\beta=%.1f$)'%(bandStr[0],beta1))
    plot.plot(temparr,area_efft1[:,1]/areapip[1],'g-',label=r'%s ($\beta=%.1f$)'%(bandStr[1],beta1))
    plot.plot(temparr,area_efft1[:,2]/areapip[2],'r-',label=r'%s ($\beta=%.1f$)'%(bandStr[2],beta1))
    plot.plot(temparr,area_efft2[:,0]/areapip[0],'bo',mfc='b',mec='b',markevery=10,label=r'%s ($\beta=%.1f$)'%(bandStr[0],beta2))
    plot.plot(temparr,area_efft2[:,1]/areapip[1],'go',mfc='g',mec='g',markevery=10,label=r'%s ($\beta=%.1f$)'%(bandStr[1],beta2))
    plot.plot(temparr,area_efft2[:,2]/areapip[2],'ro',mfc='r',mec='r',markevery=10,label=r'%s ($\beta=%.1f$)'%(bandStr[2],beta2))
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/beamarea_temp'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beamarea_temp'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/beamarea_temp_withfitdeg'+str(afitt-1)+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beamarea_temp_withfitdeg'+str(afitt-1)+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotbeamcomp(radarr,beam_sm,beam_mod,area_rarr,area_rel,fsuff,fignum,figlab):
    ...
    plot.annotate(r'PSW',(37,5.e-3),ha='right',weight='bold',size='x-large',family='sans-serif',va='center')
    plot.annotate(r'PMW',(55,5.e-3),ha='left',weight='bold',size='x-large',family='sans-serif',va='center')
    plot.annotate(r'PLW',(80,5.e-3),ha='left',weight='bold',size='x-large',family='sans-serif',va='center')
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/beamcomp'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beamcomp'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotareath(thetarr,areas,fsuff,fignum,figlab,unit='sr'):
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/beamarea_theta'+fsuff+'_'+unit
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beamarea_theta'+fsuff+'_'+unit
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotK6_va(alpharr,thetarr,K6,K5,aplot,fsuff,fignum,figlab):
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/K6_a%.1f%s'%(alpharr[aplot],fsuff)
    else:
        figname='../Docs/Presentation/Figs/Fig%s_K6_a%.1f%s'%(fignum,alpharr[aplot],fsuff)
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKc3_va(alpharr,thetarr,Kc3,Kc2,aplot,fsuff,fignum,figlab):
    ...
    #cols=['b','g','r']
    tit=[r'PSW',r'PMW',r'PLW']
    plot.plot(thetarr,Kc3[aplot,:,0]/1.e6,'b-',label=r'PSW')
    plot.plot(thetarr,Kc3[aplot,:,1]/1.e6,'g--',label=r'PMW')
    plot.plot(thetarr,Kc3[aplot,:,2]/1.e6,'r-',label=r'PLW')
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/Kc3_a%.1f%s'%(alpharr[aplot],fsuff)
    else:
        figname='../Docs/Presentation/Figs/Fig%s_Kc3_a%.1f%s'%(fignum,alpharr[aplot],fsuff)
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKc3_varel(alpharr,thetarr,Kc3rel,Kc2rel,aplot,fsuff,fignum,figlab):
    ...
    #cols=['b','g','r']
    tit=[r'PSW',r'PMW',r'PLW']
    plot.plot(thetarr,Kc3rel[aplot,:,0],'b-',label=r'PSW')
    plot.plot(thetarr,Kc3rel[aplot,:,1],'g-',label=r'PMW')
    plot.plot(thetarr,Kc3rel[aplot,:,2],'r-',label=r'PLW')
    
    plot.xlabel(r'Gaussian Source FWHM [arcsec]')
    plot.ylabel(r'Conversion parameter')
    plot.legend(loc='lower left',ncol=3,frameon=False)
    plot.annotate(r'$\alpha=%.1f$'%(alpharr[aplot]),(9.e2,500),ha='right',weight='bold',size='x-large',family='sans-serif')
    plot.yscale('log')
    plot.xscale('log')
    ...
    #plot.xticks(plot.xlim())
    plot.yticks(plot.ylim())
    plot.gca().xaxis.set_major_formatter(FormatStrFormatter('%.0f'))
    #plot.title(r'$\alpha=%.1f$'%(alpharr[aplot]))
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/Kc3rel_a%.1f%s'%(alpharr[aplot],fsuff)
    else:
        figname='../Docs/Presentation/Figs/Fig%s_Kc3rel_a%.1f%s'%(fignum,alpharr[aplot],fsuff)
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKc3t_va(alpharr,thetarr,Kc3t,Kc,aplot,fsuff,fignum,fignumz,figlab,figlabz):
    ...
    plot.clf()
    #cols=['b','g','r']  
    plot.plot(thetarr,Kc3t[aplot,:,0],'b-',label=r'PSW')
    plot.plot(thetarr,Kc3t[aplot,:,1],'g-',label=r'PMW')
    plot.plot(thetarr,Kc3t[aplot,:,2],'r-',label=r'PLW')
    ...
    yformat.set_powerlimits((-4,4))
    plot.gca().xaxis.set_major_formatter(yformat)
    plot.gca().yaxis.set_major_formatter(yformat)
    #plot.title(r'$\alpha=%.1f$'%(alpharr[aplot]))    
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/Kc3trel_a%.1f%s'%(alpharr[aplot],fsuff)
    else:
        figname='../Docs/Presentation/Figs/Fig%s_Kc3trel_a%.1f%s'%(fignum,alpharr[aplot],fsuff)
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
    ...
    if fignumz =='-':
        fignamez='../Docs/Presentation/Figs/Kc3t-zoom_a%.1f%s'%(alpharr[aplot],fsuff)
    else:
        fignamez='../Docs/Presentation/Figs/Fig%s_Kc3t-zoom_a%.1f%s'%(fignumz,alpharr[aplot],fsuff)
    plot.savefig(fignamez+'.png',transparent=False)
...
def plotKc3t_varel(alpharr,thetarr,Kc3trel,Kc,aplot,fsuff,fignum,fignumz,figlab,figlabz):
    ...
    plot.clf()
    #cols=['b','g','r']  
    plot.plot(thetarr,Kc3trel[aplot,:,0]*1.e6,'b-',label=r'PSW')
    plot.plot(thetarr,Kc3trel[aplot,:,1]*1.e6,'g-',label=r'PMW')
    plot.plot(thetarr,Kc3trel[aplot,:,2]*1.e6,'r-',label=r'PLW')
    
    plot.xlabel(r'Gaussian Source FWHM [arcsec]')
    plot.ylabel(r'[Jy per MJy/sr]')
    plot.legend(loc='upper right',ncol=1,frameon=False)
    ...
    #xformat.set_powerlimits((-3,-4))
    #plot.gca().xaxis.set_major_formatter(xformat)
    #plot.title(r'$\alpha=%.1f$'%(alpharr[aplot]))    
    ...
    if fignumz =='-':
        fignamez='../Docs/Presentation/Figs/Kc3trel-zoom_a%.1f%s'%(alpharr[aplot],fsuff)
    else:
        fignamez='../Docs/Presentation/Figs/Fig%s_Kc3trel-zoom_a%.1f%s'%(fignumz,alpharr[aplot],fsuff)
    plot.gca().set_position(pos)
    plot.savefig(fignamez+'.png',transparent=False)
    #plot.savefig(fignamez+'.eps',transparent=False)
...
def plotKc_all(alpharr,Kc,Kce,Kc3,Kc3t,fsuff,fignum,figlab):
   ...
   if fignum =='-':
       figname='../Docs/Presentation/Figs/Kc_all'+fsuff
   else:
       figname='../Docs/Presentation/Figs/Fig'+fignum+'_Kc_all'+fsuff
   plot.savefig(figname+'.png',transparent=False)
   #plot.savefig(figname+'.eps',transparent=False)
...
def plotKcKc3t_thsmall(alpharr,Kc,Kc3t,thplot,fsuff,fignum,figlab):
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/KcKc3t_thsmall'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_KcKc3t_thsmall'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    ##plot.savefig(figname+'.eps',transparent=False)
...
def plotKc2Kc3_thbig(alpharr,Kc3,Kc2,thplot,fsuff,fignum,figlab):
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/KcKc3t_thbig'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_KcKc3t_thbig'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKc2Kc3_thbigrel(alpharr,Kc3rel,Kc2rel,thplot,fsuff,fignum,figlab):
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/KcKc3t_thbigrel'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_KcKc3t_thbigrel'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKc2(alpharr,Kce,Kc2,area0,fsuff,fignum,figlab):
    ...
    plot.plot(alpharr,Kc2[:,0]/1.e6,'k-',label=r'PSW')
    plot.plot(alpharr,Kc2[:,1]/1.e6,'k--',label=r'PMW')
    plot.plot(alpharr,Kc2[:,2]/1.e6,'k:',label=r'PLW')
    ...
    plot.xlabel(r'Spectral index ($\alpha$)')
    plot.ylabel(r'$K_\mathrm{ColE}(\alpha)$ [MJy/sr per Jy]')
    plot.ylim(10,110)
    plot.xticks(plot.xlim())
    plot.yticks(plot.ylim())
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/colcorr2'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_colcorr2'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKc2rel(alpharr,Kce,Kc2rel,area0,fsuff,fignum,figlab):
    ...
    #lkc2,=plot.plot(alpharr,Kc2[:,0],'k-',label=r'$K_\mathrm{c2}$')
    #lkce,=plot.plot(alpharr,Kce[:,0]/area0[0],'k--',label=r'$K_\mathrm{c,ext}/\Omega_0$')
    plot.plot(alpharr,Kc2rel[:,0],'b-',label=r'PSW')
    plot.plot(alpharr,Kc2rel[:,1],'g-',label=r'PMW')
    plot.plot(alpharr,Kc2rel[:,2],'r-',label=r'PLW')
    ...
    plot.xlabel(r'Spectral index ($\alpha$)')
    plot.ylabel(r'$K_\mathrm{ColE}(\alpha)$')
    plot.ylim(0.75,1.05)
    plot.xticks([-4,-1,2,5])
    plot.yticks(plot.ylim())
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/colcorr2rel'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_colcorr2rel'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotblim(radarr,beam_scl_lim,beam_cmb_lim,beam_fix,brad,fsuff,fignum,figlab):
    ...
    plot.plot(radarr,beam_cmb_lim[:,0,0],'b-',label=r'Low-freq. edge',)
    plot.plot(radarr,beam_cmb_lim[:,1,0],'g-',label=r'Band centre')
    plot.plot(radarr,beam_cmb_lim[:,2,0],'r-',label=r'High-freq. edge')
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/beamlim'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beamlim'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    ###plot.savefig(figname+'.eps',transparent=False)    
...
def plotbcomb(radarr,beam_scl,beam_fix,beam_cmb,bsw,fsuff,fignum,figlab):
    ...
    lpsw,=plot.plot(radarr,beam_cmb[:,0],'b-',label=r'PSW')
    #lcmb,=plot.plot(radarr,beam_cmb[:,0],'k-',label='Combined')
    lpmw,=plot.plot(radarr,beam_cmb[:,1],'g-',label=r'PMW')
    #lfix,=plot.plot(radarr,beam_cmb[:,0],'k--',label='Fixed')
    lplw,=plot.plot(radarr,beam_cmb[:,2],'r-',label=r'PLW')
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/beamcomb'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beamcomb'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False) 
...
def plot1(nu1a,et1a,ang1b_1,beam1b_1,ang1b_2,beam1b_2,ang1b_3,beam1b_3,figAntEdge,figAntAng,labAntEdge,labAntAng):
    ...
    if figAntEdge == '-':
        figname='../Docs/Presentation/Figs/freq_edgetaper'
    else:
        figname='../Docs/Presentation/Figs/Fig'+figAntEdge+'_freq_edgetaper'
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
    ...
    if figAntAng == '-':
        figname='../Docs/Presentation/Figs/freq_angle_beam-response'
    else:
        figname='../Docs/Presentation/Figs/Fig'+figAntAng+'_freq_angle_beam-response'
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plot2(nu2a,fwhm2a_1,fwhm2a_2,nu2b,area2b_1,area2b_2,figAntFWHM,figAntArea,labAntFWHM,labAntArea):
    ...
    if figAntFWHM == '-':
        figname='../Docs/Presentation/Figs/freq_fwhm'
    else:
        figname='../Docs/Presentation/Figs/Fig'+figAntFWHM+'_freq_fwhm'
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
    ...
    if figAntArea == '-':
        figname='../Docs/Presentation/Figs/freq_beam-area'
    else:
        figname='../Docs/Presentation/Figs/Fig'+figAntArea+'_freq_beam-area'
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    ###plot.savefig(figname+'.eps',transparent=False)    
...
def plot3(nu3,ap3,fignum,figlab):
    ...
    if fignum == '-':
        figname='../Docs/Presentation/Figs/freq_ap-eff'
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_freq_ap-eff'
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plot4(nu4,area4,ap4,fignum,figlab):
    ...
    if fignum == '-':
        figname='../Docs/Presentation/Figs/freq_abs_beam-area_ap-eff'
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_freq_abs_beam-area_ap-eff'
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKct(temparr1,Kct1,beta1,temparr2,Kct2,beta2,fsuff,fignum,figlab):
    ...
    plot.plot(temparr1,Kct1[:,0],'b-',label=r'PSW ($\beta=%.1f$)'%beta1)
    plot.plot(temparr1,Kct1[:,1],'g-',label=r'PMW ($\beta=%.1f$)'%beta1)
    plot.plot(temparr1,Kct1[:,2],'r-',label=r'PLW ($\beta=%.1f$)'%beta1)
    plot.plot(temparr2,Kct2[:,0],'bo',mfc='b',mec='b',markevery=10,label=r'PSW ($\beta=%.1f$)'%beta2)
    plot.plot(temparr2,Kct2[:,1],'go',mfc='g',mec='g',markevery=10,label=r'PMW ($\beta=%.1f$)'%beta2)
    plot.plot(temparr2,Kct2[:,2],'ro',mfc='r',mec='r',markevery=10,label=r'PLW ($\beta=%.1f$)'%beta2)

    plot.xlabel(r'Temperature (K)')
    plot.ylabel(r'$K_\mathrm{ColP}(T,\beta)$')
    plot.ylim(0.85,1.15)
    plot.xlim(0,40)
    plot.xticks(plot.xlim())
    plot.yticks([plot.ylim()[0],1,plot.ylim()[1]])
    ...
    if fignum == '-':
        figname='../Docs/Presentation/Figs/colcorrt'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_colcorrt'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
###    plot.clf()
###
###    plot.plot(temparr1,Kct1[:,0],'k-',label=r'PSW ($\beta=%.1f$)'%beta1)
###    plot.plot(temparr1,Kct1[:,1],'k--',label=r'PMW ($\beta=%.1f$)'%beta1)
###    plot.plot(temparr1,Kct1[:,2],'k:',label=r'PLW ($\beta=%.1f$)'%beta1)
###    plot.plot(temparr2,Kct2[:,0],ls='-',c='0.7',lw=4,label=r'PSW ($\beta=%.1f$)'%beta2)
###    plot.plot(temparr2,Kct2[:,1],ls='--',c='0.7',lw=4,label=r'PMW ($\beta=%.1f$)'%beta2)
###    plot.plot(temparr2,Kct2[:,2],ls=':',c='0.7',lw=4,label=r'PLW ($\beta=%.1f$)'%beta2)
###
###    plot.xlabel(r'Temperature (K)')
...
###    
###    if fignum == '-':
###        figname='../Docs/Presentation/Figs/colcorrt_grey'+fsuff
###    else:
###        figname='../Docs/Presentation/Figs/Fig'+fignum+'_colcorrt_grey'+fsuff
###    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
###    #plot.savefig(figname+'.eps',transparent=False)
###    
...
def plotKct2(temparr1,Kct21,beta1,temparr2,Kct22,beta2,fsuff,fignum,figlab):
    ...
    plot.plot(temparr1,Kct21[:,0]/1.e6,'k-',label=r'PSW ($\beta=%.1f$)'%beta1)
    plot.plot(temparr1,Kct21[:,1]/1.e6,'k--',label=r'PMW ($\beta=%.1f$)'%beta1)
    plot.plot(temparr1,Kct21[:,2]/1.e6,'k:',label=r'PLW ($\beta=%.1f$)'%beta1)
    plot.plot(temparr2,Kct22[:,0]/1.e6,'ko',markevery=10,label=r'PSW ($\beta=%.1f$)'%beta2)
    plot.plot(temparr2,Kct22[:,1]/1.e6,'ks',mfc='None',markevery=10,label=r'PMW ($\beta=%.1f$)'%beta2)
    plot.plot(temparr2,Kct22[:,2]/1.e6,'ko',mfc='None',markevery=10,label=r'PLW ($\beta=%.1f$)'%beta2)

    plot.xlabel(r'Temperature (K)')
    plot.ylabel(r'$K_\mathrm{ColE}(T,\beta)$ [MJy/sr per Jy]')
    plot.ylim(0.,140.)
    plot.xlim(0,40)
    plot.xticks(plot.xlim())
    plot.yticks(plot.ylim())
    ...
    if fignum == '-':
        figname='../Docs/Presentation/Figs/colcorr2t'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_colcorr2t'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
###    plot.plot(temparr1,Kct21[:,1]/1.e6,'k--',label=r'PMW ($\beta=%.1f$'%beta1)
###    plot.plot(temparr1,Kct21[:,2]/1.e6,'k:',label=r'PLW ($\beta=%.1f$'%beta1)
###    plot.plot(temparr2,Kct22[:,0]/1.e6,ls='-',c='0.7',lw=4,label=r'PSW ($\beta=%.1f)$'%beta2)
###    plot.plot(temparr2,Kct22[:,1]/1.e6,ls='--',c='0.7',lw=4,label=r'PMW ($\beta=%.1f)$'%beta2)
###    plot.plot(temparr2,Kct22[:,2]/1.e6,ls=':',c='0.7',lw=4,label=r'PLW ($\beta=%.1f)$'%beta2)
### 
###    plot.xlabel(r'Temperature (K)')
...
###    
###    if fignum == '-':
###        figname='../Docs/Presentation/Figs/colcorr2t_grey'+fsuff
###    else:
###        figname='../Docs/Presentation/Figs/Fig'+fignum+'_colcorr2t_grey'+fsuff
###    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
###    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKct2rel(temparr1,Kct21rel,beta1,temparr2,Kct22rel,beta2,fsuff,fignum,figlab):
    ...
    plot.plot(temparr1,Kct21rel[:,0],'b-',label=r'PSW ($\beta=%.1f$)'%beta1)
    plot.plot(temparr1,Kct21rel[:,1],'g-',label=r'PMW ($\beta=%.1f$)'%beta1)
    plot.plot(temparr1,Kct21rel[:,2],'r-',label=r'PLW ($\beta=%.1f$)'%beta1)
    plot.plot(temparr2,Kct22rel[:,0],'bo',mfc='b',mec='b',markevery=10,label=r'PSW ($\beta=%.1f$)'%beta2)
    plot.plot(temparr2,Kct22rel[:,1],'go',mfc='g',mec='g',markevery=10,label=r'PMW ($\beta=%.1f$)'%beta2)
    plot.plot(temparr2,Kct22rel[:,2],'ro',mfc='r',mec='r',markevery=10,label=r'PLW ($\beta=%.1f$)'%beta2)

    plot.xlabel(r'Temperature (K)')
    plot.ylabel(r'$K_\mathrm{ColE}(T,\beta)$')
    plot.ylim(0.85,1.15)
    plot.xlim(0,40)
    plot.xticks(plot.xlim())
    plot.yticks([plot.ylim()[0],1,plot.ylim()[1]])
...
#plot.title('Colour correction factors')
    ...
    if fignum == '-':
        figname='../Docs/Presentation/Figs/colcorr2trel'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_colcorr2trel'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKcr(radlist,alphaplot,Kc2rad,bsw,fsuff,fignum,figlab):
    ...
    plot.plot(radlist,Kc2rad[:,0],'k-',label=r'PSW')
    plot.plot(radlist,Kc2rad[:,1],'k--',label=r'PMW')
    plot.plot(radlist,Kc2rad[:,2],'k:',label=r'PLW')
...
#    plot.plot(radlist,Kc2rad[:,2],'ks')
    ...
    plot.annotate(r'PSW',(bsw[0]+12,0.95*plot.ylim()[1]),color='0.7',ha='center',rotation='vertical')
    plot.annotate(r'PMW',(bsw[1]+12,0.95*plot.ylim()[1]),color='0.7',ha='center',rotation='vertical')
    plot.annotate(r'PLW',(bsw[2]+12,0.95*plot.ylim()[1]),color='0.7',ha='center',rotation='vertical')
    ...
    if fignum == '-':
        figname='../Docs/Presentation/Figs/colcorr2_R'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_colcorr2_R'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotuniant(resList,nu0List,alphaList,KcUniAnt,resPlot,nu0Plot,fignumR,fignumNu0,labnumR,labnumNu0):
    ...
    if fignumR == '-':
        figname='../Docs/Presentation/Figs/colcorrUniAntvarR'
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignumR+'_colcorrUniAntvarR'
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
    ...
    if fignumNu0 == '-':
        figname='../Docs/Presentation/Figs/colcorrUniAntvarnu0'
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignumNu0+'_colcorrUniAntvarnu0'
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotuniabs(resList,nu0List,alphaList,KcUniAbs,resPlot,nu0Plot,fignumR,fignumNu0,labnumR,labnumNu0):
    ...
    if fignumR == '-':
        figname='../Docs/Presentation/Figs/colcorrUniAbsvarR'
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignumR+'_colcorrUniAbsvarR'
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
    ...
    if fignumNu0 == '-':
        figname='../Docs/Presentation/Figs/colcorrUniAbsvarnu0'
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignumNu0+'_colcorrUniAbsvarnu0'
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotuniantext(resList,nu0List,alphaList,KcUniAntExt,resPlot,nu0Plot,fignum,figlab):
    ...
    if fignum == '-':
        figname='../Docs/Presentation/Figs/colcorrUniAntExt'
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_colcorrUniAntExt'
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotuniabsext(resList,nu0List,alphaList,KcUniAbsExt,resPlot,nu0Plot,fignum,figlab):
    ...
    if fignum == '-':
        figname='../Docs/Presentation/Figs/colcorrUniAbsExt'
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_colcorrUniAbsExt'
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKcKc2(alpharr,Kc,Kc2,fsuff,fignum,figlab):
    ...
    plot.plot(alpharr,Kc[:,0],'k-',label=r'PSW')
    plot.plot(alpharr,Kc[:,1],'k--',label=r'PMW')
    plot.plot(alpharr,Kc[:,2],'k:',label=r'PLW')
        
    plot.xlabel(r'Source spectral index ($\alpha_S$)')
    plot.ylabel(r'$K_\mathrm{colP}$')
    #plot.ylim(10,110)
    plot.legend(ncol=3,loc='upper right',frameon=False)
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/Kc'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_Kc'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
    ...
    plot.xlabel(r'Source spectral index ($\alpha_S$)')
    plot.ylabel(r'$K_\mathrm{colE}$ [MJy/sr per Jy]')
    plot.ylim(10,110)
    plot.legend(ncol=3,loc='upper right',frameon=False)
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/Kc2'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_Kc2'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKcKc2rel(alpharr,Kc,Kc2rel,fsuff,fignum,figlab):
    ...
    plot.plot(alpharr,Kc[:,0],'r-',label=r'PSW')
    plot.plot(alpharr,Kc[:,1],'g-',label=r'PMW')
    plot.plot(alpharr,Kc[:,2],'b-',label=r'PLW')
        
    plot.xlabel(r'Source spectral index ($\alpha_S$)')
    plot.ylabel(r'Colour Correction Factor $K_\mathrm{monP}$')
    #plot.ylim(10,110)
    plot.legend(ncol=3,loc='upper right',frameon=False)
    #plot.title(r'Colour Correction Factor vs.~Source Spectral index (Point Source)')
    plot.xticks(plot.xlim())
    ...
    plot.xlabel(r'Source spectral index ($\alpha_S$)')
    plot.ylabel(r'Colour Correction Factor $K_\mathrm{monE}$')
    plot.ylim(0.75,1.05)
    plot.xticks(plot.xlim())
    plot.yticks(plot.ylim())
    plot.legend(ncol=3,loc='upper right',frameon=False)
    ...
    if fignum =='-':
        figname='../Docs/Presentation/Figs/Kc2rel'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_Kc2rel'+fsuff
    plot.gca().set_position(pos)
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKctKct2(temparr1,Kct1,Kct21,beta1,temparr2,Kct2,Kct22,beta2,fsuff,fignum,figlab):
    ...
    plot.plot(temparr1,Kct1[:,1],'g--',label=r'PMW ($\beta=%.1f$)'%beta1)
    plot.plot(temparr1,Kct1[:,2],'r:',label=r'PLW ($\beta=%.1f$)'%beta1)
    plot.plot(temparr2,Kct2[:,0],'bo',mfc='None',mec='b',markevery=10,label=r'PSW ($\beta=%.1f$)'%beta2)
    plot.plot(temparr2,Kct2[:,1],'go',mfc='None',mec='g',markevery=10,label=r'PMW ($\beta=%.1f$)'%beta2)
    plot.plot(temparr2,Kct2[:,2],'ro',mfc='None',mec='r',markevery=10,label=r'PLW ($\beta=%.1f$)'%beta2)
    ...
    if fignum == '-':
        figname='../Docs/Presentation/Figs/Kct'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_Kct'+fsuff
    plot.gca().set_position(pos)
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
    ...
    if fignum == '-':
        figname='../Docs/Presentation/Figs/Kct2'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_Kct2'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotKctKct2rel(temparr1,Kct1,Kct21rel,beta1,temparr2,Kct2,Kct22rel,beta2,fsuff,fignum,figlab):
    ...
    if fignum == '-':
        figname='../Docs/Presentation/Figs/Kct2rel'+fsuff
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_Kct2rel'+fsuff
    plot.gca().set_position(pos)
    plot.savefig(figname+'.png',transparent=False)
    #plot.savefig(figname+'.eps',transparent=False)
...
def plotprettybeam(fignum,figlab,fitsIn=None,band='psw'):
    ...
    fig.show_colorscale(stretch='log',vmin=1e-5,vmax=1,cmap=cm.hot)
    ...
    fig.scalebar.show(5/60.)
    fig.scalebar.set_corner('top left')
    fig.scalebar.set(color='white',linestyle='solid',linewidth=5)
    fig.scalebar.set_label('600 "')
    #fig.scalebar.set_linewidth(5)
    
    if fignum == '-':
        figname='../Docs/Presentation/Figs/beammap_'+band
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beammap_'+band
    ...
    fig.recenter(0,0,width=2400/3600.,height=2400/3600.)
    
    fig.show_circles(0,0,600./3600,lw=3,ec='white')
    fig.show_circles(0,0,650./3600,lw=3,ec='white')
    fig.show_circles(0,0,1000./3600,lw=3,ec='black')
    fig.hide_tick_labels()
    #fig.tick_labels.set_xformat('mm:ss')
    #fig.tick_labels.set_yformat('mm:ss')
    fig.hide_axis_labels()
    #fig.add_scalebar(5/60.)    
    #fig.scalebar.show(5/60.)
    #fig.scalebar.set_label('600"')
    ...
    if fignum == '-':
        figname='../Docs/Presentation/Figs/beammap_full'+band
    else:
        figname='../Docs/Presentation/Figs/Fig'+fignum+'_beammap_'+band
    fig.save(figname+'.png')
    #fig.save(figname+'.eps')
